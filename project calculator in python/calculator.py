# -*- coding: utf-8 -*-
"""
Created on Tue Sep  3 21:06:12 2019
...
data=StringVar()
lbl=Label(root,text="lable",anchor=SE,font=("Verdana",22),textvariable= data,bg="#ffffff",fg="#000000",)
...
btnrow4=Frame(root,bg="yellow")
btnrow4.pack(expand=True,fill="both")      


# for buttons of frame btnrow1
...
btn4=Button(btnrow3,text="*",font=("Verdana",22),relief=GROOVE,border=0,command=btn_multiply_clicked,)
btn4.pack(side=LEFT,expand=True,fill="both")


# for buttons of frame btnrow4
...
btn4=Button(btnrow4,text="/",font=("Verdana",22),relief=GROOVE,border=0,command=btn_divison_clicked,)
btn4.pack(side=LEFT,expand=True,fill="both")
